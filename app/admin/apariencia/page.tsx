...
export default function AdminAparienciaPage() {
  ...
  const handleSave = async (event: React.FormEvent) => {
    ...
    const topBarBg = defaultForm.top_bar_bg ?? "#60933a";
    const topBarText = defaultForm.top_bar_text_color ?? "#f4eadc";
    const topBg = normalizeHex(palette.top_bg, defaultForm.header_bg ?? "#f4eadc");
